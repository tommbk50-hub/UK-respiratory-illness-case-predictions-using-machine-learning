...
This [dashboard](https://tommbk50-hub.github.io/UK-respiratory-illness-case-predictions-using-machine-learning/) uses historical data from the [UK Health Security Agency website](https://ukhsa-dashboard.data.gov.uk/) as well as machine learning to provide a comprehensive 52-week forecast for Influenza (Flu) and COVID-19 in England using machine learning to predict future patterns. By analysing trends in PCR Positivity and Hospital Admissions, these models aim to support healthcare resource planning—helping hospitals and A&E departments anticipate potential winter surges.
